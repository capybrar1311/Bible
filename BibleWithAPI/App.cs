...
public class App
{
    ...
    {
        string pattern = @"(\b[[1-4]А-Яа-яЁё]+\b)\s*(\d+):(\d+)";
        ...
        {
            string requestUrl =
                $"https://justbible.ru/api/bible?translation=rst&book={_bibleBooks.GetValueOrDefault(match.Groups[1].Value)}&chapter={match.Groups[2].Value}&verses={match.Groups[3].Value}";
